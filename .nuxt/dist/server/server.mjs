...
var _a;
import { hasInjectionContext, getCurrentInstance as getCurrentInstance$1, shallowReactive, reactive, effectScope, getCurrentScope, inject as inject$1, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent as defineComponent$1, createElementBlock, provide, cloneVNode, h, watch, onScopeDispose, capitalize, watchEffect, isVNode, Comment, Fragment, unref, camelize, warn, ref, computed, toRefs, toValue, createVNode, mergeProps, createElementVNode, normalizeClass, readonly, useId, normalizeStyle, TransitionGroup, Transition, nextTick, withDirectives, vShow, Text, resolveDynamicComponent, toDisplayString, markRaw, Teleport, createTextVNode, normalizeProps, guardReactiveProps, withModifiers, vModelText, resolveComponent, render, defineAsyncComponent, Suspense, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/pope/zcode/hfmg/4/fullgass/dash/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/pope/zcode/hfmg/4/fullgass/dash/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/home/pope/zcode/hfmg/4/fullgass/dash/node_modules/h3/dist/index.mjs";
import { shouldHydrate, defineStore, createPinia, setActivePinia } from "pinia";
import { defu } from "/home/pope/zcode/hfmg/4/fullgass/dash/node_modules/defu/dist/defu.mjs";
...
import { toRouteMatcher, createRouter } from "/home/pope/zcode/hfmg/4/fullgass/dash/node_modules/radix3/dist/index.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from "/home/pope/zcode/hfmg/4/fullgass/dash/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CUTTsUZz.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-CPM36rL_.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/orders-fcazaaP3.js")
  },
  {
    name: "suppliers",
    path: "/suppliers",
    component: () => import("./_nuxt/suppliers-6s2A4E24.js")
  },
  {
    name: "gas-cylinders",
    path: "/gas-cylinders",
    component: () => import("./_nuxt/gas-cylinders-ChLSj5Ef.js")
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-CsL40s-7.js").then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import("./_nuxt/empty-BPM-bNlX.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BRWtAoy8.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-mHj-lp_6.js"));
