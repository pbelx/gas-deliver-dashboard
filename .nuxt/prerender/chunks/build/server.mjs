import { defineComponent as defineComponent$1, computed, toRef, watch, capitalize, h, camelize, withDirectives, createVNode, mergeProps, createElementVNode, vShow, Fragment, toDisplayString, ref, shallowRef, watchEffect, toRefs, useId, inject as inject$1, provide, nextTick, readonly, Suspense, normalizeStyle, normalizeClass, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, resolveDynamicComponent, reactive, toValue, toRaw, isRef, TransitionGroup, Transition, unref, onScopeDispose, shallowReactive, markRaw, warn, effectScope, createElementBlock, cloneVNode, Text, Teleport, createTextVNode, withModifiers, vModelText, defineAsyncComponent, useSSRContext, createApp, isVNode, Comment, normalizeProps, guardReactiveProps, resolveComponent, render, withCtx, onErrorCaptured, onServerPrefetch, isReadonly, isShallow, isReactive, getCurrentScope } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/ofetch/dist/node.mjs';
import { b as baseURL } from '../_/renderer.mjs';
import { createHooks } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/h3/dist/index.mjs';
import { defineStore, createPinia, setActivePinia, shouldHydrate } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/pinia/dist/pinia.prod.cjs';
import { defu } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/defu/dist/defu.mjs';
import { RouterView, useRoute as useRoute$2, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/radix3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/ufo/dist/index.mjs';
import { ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///home/pope/zcode/hfmg/4/fullgass/dash/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CUTTsUZz.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-CPM36rL_.mjs')
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import('./orders-fcazaaP3.mjs')
  },
  {
    name: "suppliers",
    path: "/suppliers",
    component: () => import('./suppliers-6s2A4E24.mjs')
  },
  {
    name: "gas-cylinders",
    path: "/gas-cylinders",
    component: () => import('./gas-cylinders-ChLSj5Ef.mjs')
  }
];
...
var OrderStatus = /* @__PURE__ */ ((OrderStatus2) => {
  ...
  OrderStatus2["ASSIGNED"] = "assigned";
  OrderStatus2["IN_TRANSIT"] = "in_transit";
  OrderStatus2["DELIVERED"] = "delivered";
  OrderStatus2["CANCELLED"] = "cancelled";
  return OrderStatus2;
})(OrderStatus || {});
class ApiService {
  constructor(baseURL2 = API_BASE_URL) {
  ...
  async request(endpoint, options = {}) {
    ...
    try {
      ...
      if (!response.ok) {
        const errorPayload = (data == null ? void 0 : data.error) || (data == null ? void 0 : data.message) || `HTTP error! status: ${response.status}`;
  ...
  async getAllGasCylinders(token) {
    const headers = {};
    if (token) {
      headers.Authorization = `Bearer ${token}`;
    }
  ...
  async getGasCylinderById(id, token) {
    const headers = {};
    if (token) {
      headers.Authorization = `Bearer ${token}`;
    }
    return this.request(`/gas-cylinders/${id}`, {
      method: "GET",
      headers
    });
  }
  async createGasCylinder(cylinderData, token) {
    return this.request("/gas-cylinders", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`
  ...
  async updateGasCylinder(id, cylinderData, token) {
    return this.request(`/gas-cylinders/${id}`, {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`
  ...
  async deleteGasCylinder(id, token) {
    return this.request(`/gas-cylinders/${id}`, {
      method: "DELETE",
      headers: {
        Authorization: `Bearer ${token}`
  ...
  async getAllOrders(token, params) {
  ...
  async getCustomerOrders(customerId, token, params) {
    const queryString = params ? this.buildQueryString(params) : "";
    return this.request(`/orders/customer/${customerId}${queryString}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`
      }
  ...
  async getDriverOrders(driverId, token, params) {
    const queryString = params ? this.buildQueryString(params) : "";
    return this.request(`/orders/driver/${driverId}${queryString}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`
      }
  ...
  async getAvailableOrders(token, params) {
    const queryString = params ? this.buildQueryString(params) : "";
    return this.request(`/orders/available${queryString}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`
      }
  ...
  async getOrderStatistics(token, startDate, endDate) {
  ...
  async getOverallDashboardStats(token) {
  ...
  async getAllDrivers(token, params) {
    const queryString = params ? this.buildQueryString(params) : "";
    return this.request(`/users/role/driver${queryString}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`
      }
  ...
  async getDriverStats(driverId, token) {
    return this.request(`/users/drivers/${driverId}/stats`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`
      }
  ...
  async assignDriverToOrder(orderId, driverId, token, additionalData) {
    const payload = {
      driverId,
      ...additionalData
    };
  ...
  */
  async unassignDriverFromOrder(orderId, token) {
    return this.request(`/orders/${orderId}/unassign-driver`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`
      }
   ...
   */
  async reassignOrderToDriver(orderId, newDriverId, token, reason) {
    return this.request(`/orders/${orderId}/reassign-driver`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`
      },
  ...
  */
  async updateOrderStatusExtended(orderId, token, updateData) {
   ...
   */
  async bulkUpdateOrders(orderIds, updateData, token) {
    return this.request("/orders/bulk-update", {
      method: "PUT",
      headers: {
        Authorization: `Bearer ${token}`
      },
   ...
   */
  async getAssignableOrders(token, params) {
    const queryString = params ? this.buildQueryString(params) : "";
    return this.request(`/orders/assignable${queryString}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`
      }
   ...
   */
  async getDriverAnalytics(driverId, token, params) {
    const queryString = params ? this.buildQueryString(params) : "";
   ...
   */
  async getOrderAssignmentAnalytics(token, params) {
    const queryString = params ? this.buildQueryString(params) : "";
   ...
   */
  async notifyDriverAssignment(driverId, orderId, token) {
   ...
   */
  async notifyCustomerDriverAssigned(customerId, orderId, driverId, token) {
...
const useAuthStore = defineStore("auth", {
  ...
  getters: {
    ...
    isAdmin() {
      var _a2;
      return ((_a2 = this.getUser) == null ? void 0 : _a2.role) === "admin";
    },
    ...
    return () => {
      ...
      return isActive.value && createVNode(props.tag, {
        ...
        default: () => {
          ...
          }), ((_a2 = slots.text) == null ? void 0 : _a2.call(slots)) ?? props.text, (_b = slots.default) == null ? void 0 : _b.call(slots)]), slots.append && createElementVNode("div", {
            "key": "append",
...
const VDialog = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function onAfterEnter() {
      var _a2;
      emit("afterEnter");
      if ((props.scrim || props.retainFocus) && ((_a2 = overlay.value) == null ? void 0 : _a2.contentEl) && !overlay.value.contentEl.contains((void 0).activeElement)) {
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      return createVNode(props.tag, {
        ...
        default: () => {
          var _a2, _b;
          return [!link.isLink.value ? ((_a2 = slots.default) == null ? void 0 : _a2.call(slots)) ?? props.title : createElementVNode("a", mergeProps({
      ...
      return createVNode(props.tag, {
        ...
        default: () => {
          ...
          return [hasPrepend && createElementVNode("li", {
            ...
            return createElementVNode(Fragment, null, [((_a3 = slots.item) == null ? void 0 : _a3.call(slots, {
              item,
              index
    ...
    useRender(() => {
      ...
      return createElementVNode("div", {
        ...
        default: () => {
          ...
          }, [createElementVNode("div", null, [((_a2 = slots["thumb-label"]) == null ? void 0 : _a2.call(slots, {
    ...
    useRender(() => {
      ...
      return createVNode(VInput, mergeProps({
        ...
        prepend: hasPrepend ? (slotProps) => {
          var _a2, _b;
          return createElementVNode(Fragment, null, [((_a2 = slots.label) == null ? void 0 : _a2.call(slots, slotProps)) ?? (props.label ? createVNode(VLabel, {
    ...
    useRender(() => {
      ...
      return createVNode(VTextField, mergeProps({
        ...
        "append-inner": function() {
          ...
          return createElementVNode(Fragment, null, [(_a3 = slots["append-inner"]) == null ? void 0 : _a3.call(slots, ...args), (!props.hideNoData || props.items.length) && props.menuIcon ? createVNode(VIcon, {
...
const VConfirmEdit = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      var _a2;
      return createElementVNode(Fragment, null, [(_a2 = slots.default) == null ? void 0 : _a2.call(slots, {
        model: internalModel,
        save,
        cancel,
...
const VDataTableFooter = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [(_a2 = slots.prepend) == null ? void 0 : _a2.call(slots), createElementVNode("div", {
    ...
    useRender(() => createElementVNode("tr", {
      ...
      return createVNode(VDataTableColumn, mergeProps({
        ...
        default: () => {
          ...
          }, [((_c = slots[headerSlotName]) == null ? void 0 : _c.call(slots, columnSlotProps)) ?? column.title]), createElementVNode("div", {
...
const VTable = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => createVNode(props.tag, {
      ...
      default: () => {
        var _a2, _b, _c;
        return [(_a2 = slots.top) == null ? void 0 : _a2.call(slots), slots.default ? createElementVNode("div", {
    ...
    useRender(() => {
      ...
      return createVNode(VTable, mergeProps({
        ...
        default: () => {
          ...
          return slots.default ? slots.default(slotProps.value) : createElementVNode(Fragment, null, [(_a2 = slots.colgroup) == null ? void 0 : _a2.call(slots, slotProps.value), !props.hideDefaultHeader && createElementVNode("thead", {
            "key": "thead"
    ...
    useRender(() => {
      ...
      return createVNode(VTable, mergeProps({
        ...
        wrapper: () => {
          ...
          }, [createElementVNode("table", null, [(_a2 = slots.colgroup) == null ? void 0 : _a2.call(slots, slotProps.value), !props.hideDefaultHeader && createElementVNode("thead", {
            "key": "thead"
          }, [createVNode(VDataTableHeaders, dataTableHeadersProps, slots)]), (_b = slots.thead) == null ? void 0 : _b.call(slots, slotProps.value), !props.hideDefaultBody && createElementVNode("tbody", {
            "key": "tbody"
          ...
          }), (_d = slots["body.append"]) == null ? void 0 : _d.call(slots, slotProps.value), createElementVNode("tr", {
            "style": {
...
const VDatePicker = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function allowedMonths(month2) {
      if (typeof props.allowedDates === "function") {
        const startOfMonth2 = adapter.parseISO(`${year.value}-${month2 + 1}-01`);
    ...
    useRender(() => {
      ...
      return createVNode(VPicker, mergeProps(pickerProps, {
        ...
        title: () => {
          var _a2;
          return ((_a2 = slots.title) == null ? void 0 : _a2.call(slots)) ?? createElementVNode("div", {
...
const VEmptyState = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [((_a2 = slots.headline) == null ? void 0 : _a2.call(slots)) ?? props.headline]), hasTitle && createElementVNode("div", {
        "key": "title",
        "class": "v-empty-state__title"
      }, [((_b = slots.title) == null ? void 0 : _b.call(slots)) ?? props.title]), hasText && createElementVNode("div", {
        "key": "text",
        "class": "v-empty-state__text",
        "style": {
          maxWidth: convertToUnit(props.textWidth)
        }
      }, [((_c = slots.text) == null ? void 0 : _c.call(slots)) ?? props.text]), slots.default && createElementVNode("div", {
        "key": "content",
...
const VInfiniteScroll = genericComponent()({
  ...
  setup(props, _ref2) {
    ...
    function renderSide(side, status) {
      ...
      if (status === "empty") return ((_b = slots.empty) == null ? void 0 : _b.call(slots, slotProps)) ?? createElementVNode("div", null, [t(props.emptyText)]);
      if (props.mode === "manual") {
        if (status === "loading") {
    ...
    useRender(() => {
      ...
      return createVNode(VTextField, mergeProps({
        ...
        "append-inner": hasAppendInner ? function() {
          ...
          return createElementVNode(Fragment, null, [(_a2 = slots["append-inner"]) == null ? void 0 : _a2.call(slots, ...args), appendInnerControl]);
        } : void 0,
        "prepend-inner": hasPrependInner ? function() {
          ...
          return createElementVNode(Fragment, null, [prependInnerControl, (_a2 = slots["prepend-inner"]) == null ? void 0 : _a2.call(slots, ...args)]);
        } : void 0
      });
    });
...
const VStepperItem = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      }, [((_a2 = slots.title) == null ? void 0 : _a2.call(slots, slotProps.value)) ?? props.title]), hasSubtitle && createElementVNode("div", {
        "key": "subtitle",
        "class": "v-stepper-item__subtitle"
      }, [((_b = slots.subtitle) == null ? void 0 : _b.call(slots, slotProps.value)) ?? props.subtitle]), (_c = slots.default) == null ? void 0 : _c.call(slots, slotProps.value)])]), [[Ripple, props.ripple && props.editable, null]]);
    });
    return {};
  }
});
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode(VBtn, mergeProps({
        ...
        default: () => {
          var _a2;
          return createElementVNode(Fragment, null, [((_a2 = slots.default) == null ? void 0 : _a2.call(slots)) ?? props.text, !props.hideSlider && createElementVNode("div", {
            "ref": sliderEl,
    ...
    theme: {
      ...
      themes: {
        light: {
          ...
          colors: {
            primary: "#1976D2",
            // Example primary color (Material Blue)
            secondary: "#424242",
            // Example secondary color (Material Grey Darken-3)
            accent: "#82B1FF",
            // Example accent color (Material Blue A100)
            error: "#FF5252",
            // Example error color (Material Red A200)
            info: "#2196F3",
            // Example info color (Material Blue)
            success: "#4CAF50",
            // Example success color (Material Green)
            warning: "#FB8C00"
            // Example warning color (Material Orange)
          }
        },
        dark: {
          dark: true,
          colors: {
            primary: "#2196F3",
            // Example primary color for dark theme
            secondary: "#757575"
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CsL40s-7.mjs').then((m) => m.default || m)),
  empty: defineAsyncComponent(() => import('./empty-BPM-bNlX.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BRWtAoy8.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-mHj-lp_6.mjs'));
...
export { VListItem as A, VListItemTitle as B, VListItemSubtitle as C, VChip as D, VAvatar as E, VTextarea as F, VCardActions as G, VSpacer as H, VDataTable as I, VMenu as J, VList as K, VImg as L, VApp as M, VNavigationDrawer as N, OrderStatus as O, VListGroup as P, VAppBar as Q, VAppBarNavIcon as R, VMain as S, VContainer as V, __nuxt_component_0 as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, useApiService as d, entry$1 as default, useAuthStore as e, VRow as f, VCol as g, VSkeletonLoader as h, VCard as i, VCardItem as j, VAlert as k, VCardTitle as l, VCardText as m, navigateTo as n, VToolbar as o, VToolbarTitle as p, VIcon as q, resolveRouteObject as r, VForm as s, tryUseNuxtApp as t, useRouter$1 as u, VTextField as v, VBtn as w, VDialog as x, VDivider as y, VSelect as z };
